...
<head>
    ...
    <style>
        .swatch { width: 28px; height: 28px; border-radius: 50%; border: 2px solid #dee2e6; display: inline-block; vertical-align: middle; }
        .fabric-img { width: 50px; height: 50px; object-fit: cover; border-radius: 6px; border: 1px solid #eee; }
        .price-plus { color: #27ae60; font-weight: 600; }
        .price-minus { color: #e74c3c; font-weight: 600; }
        .price-zero  { color: #6c757d; }
        .action-btn { width: 32px; height: 32px; display: inline-flex; align-items: center; justify-content: center; border-radius: 50%; padding: 0; }
        .modal-swatch-preview { width: 36px; height: 36px; border-radius: 50%; border: 2px solid #dee2e6; display: inline-block; vertical-align: middle; margin-left: 8px; }
    </style>
</head>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <small class="text-danger">This cannot be undone and will remove the fabric from all products.</small></p>
                </div>
