        ...
        <div class="container">
            <div class="footer-button-area">
                <div class="row g-4 mb-100">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a class="primary-btn footer-btn" href="<?= BASE_URL ?>faq.php">
                            Ask any questions
                            <svg class="arrow" width="10" height="10" viewBox="0 0 10 10" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 9L9 1M9 1C7.22222 1.33333 3.33333 2 1 1M9 1C8.66667 2.66667 8 6.33333 9 9"
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a class="primary-btn footer-btn" href="mailto:<?= $contact['email'] ?>">
                            Email - <span class="__cf_email__" data-cfemail="066f686069637e676b766a6346616b676f6a2865696b"><?= $contact['email'] ?></span>
                            <svg class="arrow" width="10" height="10" viewBox="0 0 10 10" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 9L9 1M9 1C7.22222 1.33333 3.33333 2 1 1M9 1C8.66667 2.66667 8 6.33333 9 9"
                                    stroke="#1E1E1E" stroke-width="1.5" stroke-linecap="round"></path>
                    ...
                    <div class="footer-logo-section">
                        <div class="footer-top-section">
                            <div class="footer-logo">
                                <a href="<?= BASE_URL ?>">
                                    <h1 class="text-light">The Best</h1>
                                </a>
                            </div>
                            <a class="office-location" href="https://www.google.com/maps"><?= $contact['address'] ?></a>
                            <ul>
                                <li>
                            ...
                            <div class="payment-gateway">
                                ...
                                <div class="icons">
                                    <img src="<?= BASE_URL ?>assets/image/home1/visa.png" alt="">
                                    <img src="<?= BASE_URL ?>assets/image/home1/mastercard.png" alt="">
                                    <img src="<?= BASE_URL ?>assets/image/home1/american-exprees.png" alt="">
                                    <img src="<?= BASE_URL ?>assets/image/home1/maetro.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="footer-btm-content">
                            <div class="copyright-area">
                                <p> © Copyright 2025 <a href="<?= BASE_URL ?>"><?= $contact['company_name'] ?> </a> | Design By<a href="https://www.vrwebsitedesigning.com/"> VR Website Designing</a> </p>
                            </div>
